...
\newglossaryentry{vhdl}{
  name={VHDL},
  description={\bold{V}ery-high-speed integrated circuits \bold{h}ardware \bold{d}escription
		\bold{l}anguage. See also \gls{hdl}},
  text={VHDL},
...
\newglossaryentry{html}{
  name={HTML},
  description={\bold{H}yper \bold{T}ext \bold{M}arkup \bold{L}anguage; A language to describe the layout of text and media.},
  text={HTML},
