...
If the matchvector points into such a cluster, the design is identified with the
...
Since it is expected, that the validity of such clusters increases with the number of analyzed designs, an automatic process has to be established, to enable the analysis of a great amount of designs. To achieve this, we use Scrapy, a Python web scraping tool, to 
